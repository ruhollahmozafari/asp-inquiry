...
# from azbankgateways.models.enum import BankType, PaymentStatus
...
# from azbankgateways.exceptions import CurrencyDoesNotSupport, AmountDoesNotSupport, BankGatewayTokenExpired, BankGatewayStateInvalid
# from azbankgateways.models import Bank, CurrencyEnum, PaymentStatus
...
# ####################################
#     def set_inquiry_id(self, inquiry_id):
...
#             inquiry_id=self.get_inquiry_id(),  ########################################
